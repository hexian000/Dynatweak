...
public class BootReceiver extends BroadcastReceiver {
    ...
    static void tweak(int hotplug, int profile) throws IOException {
            ...
            for (int trial = 0; trial < 3; trial++) {
                try {
                    ...
                    if (profile != PROFILE_DISABLED) {
                        ...
                        Log.d("Dynatweak", "tweaking cpu " + cpu.getId() +
        ...
        for (int i = 0; i < allPolicy.size(); i++) {
            ...
            if (profile != PROFILE_DISABLED)
                Log.d("Dynatweak", "tweaking cluster " + i +
    ...
    private static void tweakGovernor(Kernel k, Kernel.CpuCore cpu, String policy, String governor, int profile) throws IOException {
        switch (profile) {
            case PROFILE_POWERSAVE: // powersave
                switch (governor) {
                    case "interactive":
                        k.trySetNode(policy + "/interactive/hispeed_freq", cpu.fitFrequency(1000000) + "");
                        k.trySetNode(policy + "/interactive/sync_freq", cpu.fitFrequency(0) + "");
            ...
            case PROFILE_BANLANCED: // balanced
                switch (governor) {
                    case "interactive":
                        k.trySetNode(policy + "/interactive/hispeed_freq", cpu.fitFrequency(1200000) + "");
                        k.trySetNode(policy + "/interactive/sync_freq", cpu.fitFrequency(900000) + "");
                        k.trySetNode(policy + "/interactive/up_threshold_any_cpu_freq", cpu.fitPercentage(0.9) + "");
                        k.trySetNode(policy + "/interactive/above_hispeed_delay", "0 1000000:10000 1700000:20000 2400000:30000");
                        k.trySetNode(policy + "/interactive/go_hispeed_load", "95");
                        k.trySetNode(policy + "/interactive/target_loads", "60 1000000:70 1700000:80 2400000:90");
                        ...
                        break;
                    case "blu_active":
                        k.trySetNode(policy + "/blu_active/above_hispeed_delay", "20000 1400000:40000 1700000:20000 2100000:80000 2400000:100000");
                        ...
                        k.trySetNode(policy + "/blu_active/hispeed_freq", cpu.fitFrequency(1200000) + "");
                        k.trySetNode(policy + "/blu_active/io_is_busy", "0");
                        k.trySetNode(policy + "/blu_active/min_sample_time", "20000");
                        k.trySetNode(policy + "/blu_active/target_loads", "85 1500000:90 1800000:70 2100000:95");
            ...
            case PROFILE_PERFORMANCE: // performance
                switch (governor) {
                    case "interactive":
                        k.trySetNode(policy + "/interactive/above_hispeed_delay", "0 1000000:10000 1700000:20000 2400000:30000");
                        k.trySetNode(policy + "/interactive/hispeed_freq", cpu.fitFrequency(1400000) + "");
                        k.trySetNode(policy + "/interactive/sync_freq", cpu.fitFrequency(900000) + "");
                        ...
                        break;
                    case "blu_active":
                        k.trySetNode(policy + "/blu_active/above_hispeed_delay", "0 1000000:10000 1700000:20000 2400000:30000");
                        k.trySetNode(policy + "/blu_active/align_windows", "1");
                        k.trySetNode(policy + "/blu_active/fastlane", "1");
                        k.trySetNode(policy + "/blu_active/fastlane_threshold", "25");
                        k.trySetNode(policy + "/blu_active/go_hispeed_load", "80");
                        k.trySetNode(policy + "/blu_active/hispeed_freq", cpu.fitFrequency(1400000) + "");
                        k.trySetNode(policy + "/blu_active/io_is_busy", "0");
                        k.trySetNode(policy + "/blu_active/min_sample_time", "20000");
                    ...
                    case "ondemand":
                        ...
                        k.trySetNode(policy + "/ondemand/optimal_freq", cpu.fitFrequency(1400000) + "");
                        ...
                        k.trySetNode(policy + "/ondemand/sync_freq", cpu.fitFrequency(1200000) + "");
            ...
            case PROFILE_GAMING: //gaming
                switch (governor) {
                    case "interactive":
                        k.trySetNode(policy + "/interactive/hispeed_freq", cpu.fitFrequency(1400000) + "");
                        k.trySetNode(policy + "/interactive/sync_freq", cpu.fitFrequency(1200000) + "");
                        k.trySetNode(policy + "/interactive/up_threshold_any_cpu_freq", cpu.fitFrequency(1700000) + "");
                        k.trySetNode(policy + "/interactive/above_hispeed_delay", "0 1000000:10000 1700000:20000 2400000:30000");
                        k.trySetNode(policy + "/interactive/go_hispeed_load", "80");
                        k.trySetNode(policy + "/interactive/target_loads", "50");
                        k.trySetNode(policy + "/interactive/up_threshold_any_cpu_load", "70");
